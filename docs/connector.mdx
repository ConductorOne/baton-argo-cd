...
- `get`/`patch` on `secrets`: Read and purge a deprovisioned account's stored credentials in `argocd-secret`. Only needed for account deprovisioning; omit both if you do not use it.
